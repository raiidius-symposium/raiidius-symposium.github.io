...
const speakers2026: Speaker[] = [
  {
    ...
    bio: 'Dr. Reyes Nieva is a biomedical informatician specializing in artificial intelligence (AI) in medicine and public health. His research aims to advance precision health for all populations by harnessing AI and informatics to accelerate scientific knowledge discovery and translation at scale, strengthen next-generation learning health systems, and interrogate the ethical, legal, and social considerations necessary for the development of human-centered AI. Dr. Reyes Nieva’s research is informed by a decade and a half of domestic and international experience in health systems strengthening and humanitarian efforts including roles in strategic information for the U.S. President’s Emergency Plan for AIDS Relief (PEPFAR) program at Harvard University and a three-year term as a Commissioner of Human Rights. Dr. Reyes Nieva received his PhD in Biomedical Informatics from Columbia University, while concurrently a Visiting Postgraduate Research Fellow in the Department of Medicine at Harvard Medical School. He also holds a Master of Applied Science in Spatial Analysis from the Johns Hopkins Bloomberg School of Public Health and a BA in History and Sociology from Yale University. Recently he was named a STAT Wunderkind, which highlights 30 of the top early-career researchers in health and medicine in North America.',
  ...
  },
  {
    ...
    bio: 'Dr. Castor is an Assistant Professor in the Division of Infectious Diseases at Columbia University Irving Medical Center (CUIMC). She is an epidemiologist who studies how to deliver public health innovations at scale by examining the unique and joint effects of biomedical, behavioral and structural factors that affect infectious diseases in priority populations in low- and middle-income country settings (LMICS), and in marginalized populations in the US. Prior, she led implementation research activities within the President\’s Emergency Plan for AIDS Relief (PEPFAR) at two US government agencies; as acting chief of the Implementation Science branch of the USAID Office of HIV/AIDS and Senior Epidemiologist in the Department of State Office of the Global AIDS Coordinator. Dr. Castor worked within PEPFAR-supported programs to design, implement, and evaluate comprehensive HIV interventions and introduce and scale-up novel prevention technologies. Her HIV research involves intersecting areas of interest such as women’s and reproductive health, health disparities, mental health, nutrition, cervical cancer and other emerging infections (i.e., SARS-CoV-2).',    keywords: ['Epidemiology', 'Implementation Science', 'Surveillance', 'Public Health'],
