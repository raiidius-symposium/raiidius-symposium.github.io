...
const speakers2026: Speaker[] = [
  {
    ...
    bio: 'Dr. Reyes Nieva is a biomedical informatician specializing in artificial intelligence (AI) in medicine and public health. His research aims to advance precision health for all by harnessing AI and informatics to accelerate scientific knowledge discovery and translation at scale, strengthen next-generation learning health systems, and interrogate the ethical, legal, and social considerations necessary for the development of human-centered AI. Dr. Reyes Nieva’s research is informed by a decade and a half of domestic and international experience in health systems strengthening and humanitarian efforts including roles in strategic information for the U.S. President’s Emergency Plan for AIDS Relief (PEPFAR) program at Harvard and a three-year term as a Commissioner of Human Rights. Dr. Reyes Nieva received his PhD in Biomedical Informatics from Columbia University, while concurrently a Visiting Postgraduate Research Fellow at Harvard Medical School. He also holds a Master of Applied Science in Spatial Analysis from the Johns Hopkins Bloomberg School of Public Health and a BA in History and Sociology from Yale University. Recently he was named a STAT Wunderkind, which highlights 30 of the top early-career biomedical researchers in North America.',
