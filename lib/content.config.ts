...
const speakers2026: Speaker[] = [
  {
    ...
    title: 'Assistant Professor of Medicine (in Medicine and in Biomedical Informatics)',
    role: 'keynote',
    bio: 'Dr. Reyes Nieva...',
...
//    affiliation: 'Columbia University, Heilbrunn Department of Population and Family Health',
//    title: 'Adjunct Assistant Professor',
//    role: 'panelist',
//    bio: 'Dr. Abdool Karim is a public health lawyer whose research focuses on using the law to improve health outcomes',
...
//    keywords: ['Community Advocacy', 'Patient Engagement', 'Health Access', 'Ethics'],
  {
    ...
    affiliation: 'CUIMC Division of Infectious Diseases',
   title: 'Harold C. Neu Professor of Infectious Diseases (in Medicine) and Chief of Infectious Diseases at CUIMC',
    role: 'panelist',
