...
const speakers2026: Speaker[] = [
  ...
  },
  {
    ...
    keywords: ['HIV', 'Health Policy', 'Mathematical Modeling', 'Cost-effectiveness Analysis', 'Vaccines'],
  ...
  },
  {
    ...
    affiliation: 'Johnson & Johnson Innovative Medicine',
...
const agenda2026: Session[] = [
  ...
  {
    id: 'fireside-1',
    title: 'Fireside Chat with Rochelle Walensky, MD, MPH - 19th Director of the CDC (2021-2023)',
    format: 'session',
    startTime: '9:20 AM',
    endTime: '10:00 AM',
    description: 'Dr. Rochelle Walensky will discuss the role of AI and informatics in the future of infectious disease research, care delivery, and public health. The conversation will explore the promise, limitations, and real-world implications of these technologies in practice.',
    location: 'VEC 201',
    speakers: ['speaker-7'],
  },
  {
  ...
  },
  {
   ...
   {
    id: 'panel-1',
    title: 'Panel Session 1: Responsible AI Across the STI Research & Practice Continuum - From Clinics to Communities',
    format: 'panel',
    startTime: '11:00 AM',
    endTime: '12:00 PM',
  ...
  }, 
  {
    ...
    startTime: '12:00 PM',
    endTime: '1:00 PM',
    description: 'Lunch will be provided for registered attendees. Attendees are encouraged to use this time to connect with colleagues, continue conversations from the morning sessions, and discuss key topics related to the responsible use of AI and informatics in infectious disease research, practice, and policy.',
  ...
  {
    id: 'panel-2',
    title: 'Panel Session 2: Responsible AI Across the STI Research & Practice Continuum - From Bench to Bedside',
    format: 'panel',
    startTime: '2:00 PM',
    endTime: '3:00 PM',
