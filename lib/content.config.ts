...
const speakers2026: Speaker[] = [
  {
    ...
    bio: 'Dr. Reyes Nieva is a biomedical informatician specializing in artificial intelligence (AI) in medicine and public health. His research aims to advance precision health for all populations by harnessing AI and informatics to accelerate scientific knowledge discovery and translation at scale, strengthen next-generation learning health systems, and interrogate the ethical, legal, and social considerations necessary for the development of human-centered AI. Dr. Reyes Nieva completed his PhD in Biomedical Informatics from Columbia University, while concurrently a Visiting Postgraduate Research Fellow in the Department of Medicine at Harvard Medical School. He was also a Deutscher Akademischer Austauschdienst (DAAD) AInet Fellow in Safety and Security in AI, part of an academic exchange initiative funded by the German Federal Ministry of Education and Research. In addition to degrees in biomedical informatics, Dr. Reyes Nieva holds a Master of Applied Science in Spatial Analysis from the Johns Hopkins Bloomberg School of Public Health and a Bachelor of Arts in History and Sociology from Yale University. Recently he was named a STAT Wunderkind, which highlights 30 of the top early-career researchers in health and medicine in North America.',
