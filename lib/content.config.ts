...
const agenda2026: Session[] = [
  ...
  },
  {
    ...
    startTime: '11:00 AM',
    endTime: '12:00 PM',
    description: 'Panel brings together leaders in clinical epidemiology, machine learning, implementation science, and public health practice to examine the promise and perils of AI and informatics across clinical care, population-level discovery, surveillance, prevention, and public health action in sexually transmitted infections.',
    location: 'VEC 201',
    speakers: ['speaker-10','speaker-6'],
  },
  {
    id: 'lunch-roundtable',
    ...
    {
    id: 'panel',
    title: 'Panel Discussion: Responsible AI Across the STI Research Continuum - From Molecules to Medicine',
    format: 'panel',
    startTime: '1:00 PM',
    endTime: '2:00 PM',
    description: 'Panel brings together leaders in computational biology, translational science, clinical informatics, and STI care to examine the promise and perils of AI and informatics across biological discovery, translational investigation, and clinical care in sexually transmitted infections.',
    location: 'VEC 201',
